...
public class RepositorioRestaurantes<T extends Identificable> implements RepositorioString<T> {
	...
	String connectionString = System.getenv("//Aure:arso@ac-gbkha7k-shard-00-00.gbzbs08.mongodb.net:27017,ac-gbkha7k-shard-00-01.gbzbs08.mongodb.net:27017,ac-gbkha7k-shard-00-02.gbzbs08.mongodb.net:27017/?ssl=true&replicaSet=atlas-ekxpjk-shard-0&authSource=admin&retryWrites=true&w=majority"); 
