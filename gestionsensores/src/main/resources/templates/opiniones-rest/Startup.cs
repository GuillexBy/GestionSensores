...
namespace OpinionesApi
{
    public class Startup
    {
        ...
        {
            var factory = new ConnectionFactory{Uri=new Uri("amqps://egedtdxz:9F9-pdh4iD3HLyexhCaxZBDwyHH_Lq0d@stingray.rmq.cloudamqp.com/egedtdxz")};
            var connection = factory.CreateConnection();
            var channel = connection.CreateModel();
            channel.ExchangeDeclare("evento.valoracion.creada", "direct", true, false, null);
